...
A copy of the plugin can be downloaded from {Little Stream Software}[https://projects.littlestreamsoftware.com/projects/redmine-recent-issues/files] or from {GitHub}[http://github.com/edavis10/redmine_recent_issues]
